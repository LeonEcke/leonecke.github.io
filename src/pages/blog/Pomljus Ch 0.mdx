---
title: Pomoljus Ch.0
description: "What is this? This is the introductory post in a future series of posts that together will follow the development of a project named Pomoljus. This project log will introduce the Pomodoro Timer from inspiration and early concepts into the more defined concepts."
...
<table>
    <tr>
        <img src="/images/Ch0/Ch0_1.png" width="300px" align="left"/>
        <img src="/images/Ch0/Ch0_2.png" width="300px" align="center"/>
    </tr>
</table>
...
<img src="/images/Ch0/Ch0_6.png" width="420px" align="right"/>
...
<img src="/images/Ch0/Ch0_10.png" width="500px" align="center"/>
...
Then I also have some data, in the form of input to the RGB LEDs, and output from the two buttons. An issue with the RP2040 would be the fact that it's not officially<sup>[4]</sup> 5V compliant. Which means that I need to level shift both of these data signals. This was harder to find out how to properly do than it was to actually do. Since both data lines are high impedance, meaning there's no real current draw worth calling home about, you can get away with some pretty simple step-up/down circuits. I'll go over the details more in Ch.1. 

## What's next

As of writing this, I have already designed and ordered the second revision of the light bar PCB. I'll maybe manage to write together the next chapter, which will be about my design of the PCB itself. I've had some thoughts about the general design too since then, as the battery is much larger than I expected and the 7 segment much thicker. But that I might just mention in passing... I guess we'll see.
...
4. https://hackaday.com/2023/04/05/rp2040-and-5v-logic-best-friends-this-fx9000p-confirms/
